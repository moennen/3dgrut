...
| variant   | scenes | psnr      | ssim      | lpips     | d_absrel   | d_rmse    | d_delta1  | d_bias | d_cover   | d_float    |
|-----------|--------|-----------|-----------|-----------|------------|-----------|-----------|--------|-----------|------------|
| gaussian  | 4      | **35.22** | **0.961** | **0.116** | **0.0873** | **4.253** | **0.890** | -1.538 | 0.984     | **0.0069** |
| trisurfel | 4      | 33.72     | 0.949     | 0.133     | 0.0998     | 5.642     | 0.855     | -2.579 | **0.991** | 0.0344     |
...
|-----------|--------|------|---------|---------|--------|----------|
| gaussian  | 4      | 70.9 | 109     | 513,117 | 0.81   | 1.60     |
| trisurfel | 4      | 85.2 | 83      | 516,408 | 0.81   | 1.69     |
...
## depth_floater_frac per scene

| scene          | gaussian | trisurfel |
|----------------|----------|-----------|
| classroom      | 0.0005   | 0.0005    |
| emerald-square | 0.0236   | 0.1348    |
| lone-monk      | 0.0001   | 0.0001    |
| sponza         | 0.0034   | 0.0022    |
